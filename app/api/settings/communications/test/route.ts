    ...
    if (type === 'sms') {
      ...
      try {
        ...
        const testMessage = testData.message ||
          "This is a test message from Dr. Dev's Dental Hospital. Your SMS gateway is configured correctly."
    ...
    if (type === 'email') {
      ...
      try {
        ...
        const testSubject = testData.subject ||
          "Test Email from Dr. Dev's Dental Hospital"

        const testBody = testData.body || `
          <div style="font-family: Arial, sans-serif; padding: 20px;">
            <h2>Email Configuration Test</h2>
            <p>Hello,</p>
            <p>This is a test email from Dr. Dev's Dental Hospital.</p>
