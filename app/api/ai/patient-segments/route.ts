...
Return ONLY valid JSON, no markdown.`,
    ...
    try {
      ...
      for (const s of segmented) {
        switch (s.segment) {
          case "VIP": counts.vip++; break
          case "LOYAL": counts.loyal++; break
          case "REGULAR": counts.regular++; break
          case "AT_RISK": counts.atRisk++; break
          case "CHURNING": counts.churning++; break
