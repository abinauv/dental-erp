      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-sm text-gray-600 mt-1">Items below minimum</p>
          </div>
              ...
              {reportData.map((item: any) => (
                <tr key={item.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                    {item.supplier_name || '-'}
                    {item.supplier_phone && (
                      <div className="text-xs text-gray-400">{item.supplier_phone}</div>
                    )}
                  </td>
                </tr>
              ))}
    ...
    return (
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-sm font-medium text-gray-500">Expired Batches</h3>
            <p className="text-3xl font-bold mt-2 text-red-600">
    ...
    return (
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-sm font-medium text-gray-500">Average Item Value</h3>
