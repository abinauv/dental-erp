...
class TemplateService {
  ...
  private readonly standardVariables: TemplateVariable[] = [
    ...
    { key: 'doctorName', label: 'Doctor Name', description: 'Name of the doctor', example: 'Dr. Dev' },
    ...
    { key: 'clinicName', label: 'Clinic Name', description: 'Name of the clinic', example: 'Dr. Dev\'s Dental Hospital' },
    { key: 'clinicPhone', label: 'Clinic Phone', description: 'Clinic contact number', example: '044-12345678' },
    { key: 'clinicEmail', label: 'Clinic Email', description: 'Clinic email address', example: 'info@drdevdental.com' },
