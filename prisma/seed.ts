...
async function main() {
  ...
  const hospital = await prisma.hospital.upsert({
    where: { slug: 'dr-devs-dental' },
    update: {},
    create: {
      name: "Dr. Dev's Dental Hospital",
      slug: 'dr-devs-dental',
      email: 'info@drdevsdental.com',
      phone: '044-12345678',
  ...
  const admin = await prisma.user.upsert({
    where: { email: 'admin@drdevsdental.com' },
    update: {},
    create: {
      email: 'admin@drdevsdental.com',
      name: 'Dr. Dev',
  ...
  const doctor = await prisma.user.upsert({
    where: { email: 'doctor@drdevsdental.com' },
    update: {},
    create: {
      email: 'doctor@drdevsdental.com',
      name: 'Dr. Priya',
  ...
  const receptionist = await prisma.user.upsert({
    where: { email: 'reception@drdevsdental.com' },
    update: {},
    create: {
      email: 'reception@drdevsdental.com',
      name: 'Lakshmi S',
