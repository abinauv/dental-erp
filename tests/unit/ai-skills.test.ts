...
const EXPECTED_ROLE_SKILLS: Record<string, string[]> = {
  ...
  RECEPTIONIST: ["patient-intake", "smart-scheduler", "whatsapp-receptionist", "no-show-predictor", "inventory-forecaster"],
  DOCTOR: ["treatment-advisor", "lab-coordinator", "clinic-analyst", "no-show-predictor", "patient-segmentation", "consent-generator"],
